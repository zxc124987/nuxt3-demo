import { hasInjectionContext, inject, version, unref, ref, warn, computed, getCurrentInstance, defineComponent, watch, renderSlot, openBlock, createElementBlock, mergeProps, normalizeClass, createVNode, Transition, withCtx, withDirectives, createElementVNode, normalizeStyle, toDisplayString, vShow, shallowReactive, createBlock, createCommentVNode, resolveDynamicComponent, Fragment, withModifiers, h, provide, Suspense, nextTick, isRef, useSSRContext, createApp, effectScope, reactive, getCurrentScope, isVNode, onErrorCaptured, onServerPrefetch, toRef, render, defineAsyncComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, i as createError$1, p as klona, q as parse, t as getRequestHeader, v as defu, x as sanitizeStatusCode, y as destr, z as isEqual, A as setCookie, B as getCookie, C as deleteCookie, D as createHooks, E as toRouteMatcher, F as createRouter$1 } from '../runtime.mjs';
...
import { isNil, get, set, fromPairs } from 'lodash-unified';
import { camelize, isString, isObject, hasOwn, NOOP, isFunction } from '@vue/shared';
...
const _routes = [
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-mL86thNW.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-CmxR6qa2.mjs').then((m) => m.default || m)
  },
  {
    name: "room",
    path: "/room",
    component: () => import('./index-CgxHpyPe.mjs').then((m) => m.default || m)
  },
  {
    name: void 0 ,
    path: "/verify/:workNo()",
    component: () => import('./_workNo_-Dzku-Dpm.mjs').then((m) => m.default || m),
    children: [
      {
        name: "verify-workNo-category-number",
        path: ":category()/:number()",
        component: () => import('./_number_-BasX5ZEM.mjs').then((m) => m.default || m)
      },
      {
        name: "verify-workNo-category",
        path: "category",
        component: () => import('./category-BNss0K2c.mjs').then((m) => m.default || m)
      },
      {
        name: "verify-workNo",
        path: "",
        component: () => import('./index-DtjPBBck.mjs').then((m) => m.default || m)
      }
    ]
  },
  {
    name: "verify",
    path: "/verify",
    component: () => import('./index-gkO8Yrlm.mjs').then((m) => m.default || m)
  }
];
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to, from) => {
  ...
  if (!isLogin.value && to.name !== "index") {
    ElMessage({
      message: "無權限，進入失敗!",
      type: "error",
      duration: 3e3
    });
    [__temp, __restore] = executeAsync(() => new Promise((resolve) => setTimeout(resolve, 1e3))), await __temp, __restore();
    return navigateTo("/");
  }
});
...
const layouts = {
  default: () => import('./default-pRHt4fBc.mjs').then((m) => m.default || m),
  login: () => import('./login-HXCrrWOu.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DhICvFTl.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DoP_Bnd0.mjs').then((r) => r.default || r));
...
export { useNuxtApp as $, useLocale as A, useEmptyValues as B, isUndefined as C, EVENT_CODE as D, ElMessage as E, circle_close_default as F, arrow_down_default as G, useEmptyValuesProps as H, d_arrow_left_default as I, more_filled_default as J, d_arrow_right_default as K, useGlobalSize as L, arrow_left_default as M, arrow_right_default as N, arrow_up_default as O, addClass as P, isElement as Q, hasClass as R, removeClass as S, loading_default as T, view_default as U, ValidateComponentsMap as V, hide_default as W, useRouter as X, nuxtLinkDefaults as Y, resolveRouteObject as Z, _export_sfc as _, useNamespace as a, useRuntimeConfig as a0, more_default as a1, question_filled_default as a2, isPropAbsent as a3, caret_right_default as a4, useGlobalConfig as a5, buildProp as a6, useGetDerivedNamespace as a7, useIdInjection as a8, useZIndex as a9, asyncDataDefaults as aa, createError as ab, fetchDefaults as ac, useRequestFetch as ad, useGlobalComponentSettings as ae, getStyle as af, buildProps as b, _export_sfc$1 as c, definePropType as d, entry$1 as default, isNumber as e, componentSizes as f, isBoolean as g, debugWarn as h, injectHead as i, useId as j, addUnit as k, getProp as l, mutable as m, navigateTo as n, withNoopInstall as o, useSizeProp as p, useRoute as q, resolveUnrefHeadInput as r, __nuxt_component_1 as s, throwError as t, useCookie as u, document_default as v, withInstall as w, ElIcon as x, close_default as y, iconPropType as z };
